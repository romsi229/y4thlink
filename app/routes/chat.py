...
TWILIO_ACCOUNT_SID = os.getenv("TWILIO_ACCOUNT_SID", "METS_TON_ACCOUNT_SID_ICI")
TWILIO_AUTH_TOKEN = os.getenv("TWILIO_AUTH_TOKEN", "METS_TON_AUTH_TOKEN_ICI")
...
reponses = {
    "fr": {
        ...
        "info": "📚 Sujets : contraception, grossesse, IST, violence. Tape le sujet qui t'intéresse.",
        "contraception": "La pilule se prend chaque jour à la même heure. Efficace à 99%. Tape rdv pour un rendez-vous.",
    ...
    "en": {
        ...
        "info": "📚 Topics: contraception, pregnancy, STI, violence. Type the topic you want.",
...
async def whatsapp(request: Request):
    try:
        ...
        print(f"Message recu: {msg} de {expediteur}")
        ...
        print(f"Message envoye SID: {message_envoye.sid}")
